...
独立的 Minecraft Bedrock 每日日常、动态事件与多副本 Addon。v0.18.0 增加普通、高级两种自然分布的实体随机箱：仅生成在主世界法制区/非法制区，摸金都市与安全区不会生成；玩家必须在 1 格内左键或右键开启，物资落地后箱体消失。高级实体箱和无品质废墟方块箱均有独立 1% 概率开出随机 Epic 蓝图。v0.17.0 将实时事件报道更名为“每日突发事件”，并增加每日一期“希望报”。
