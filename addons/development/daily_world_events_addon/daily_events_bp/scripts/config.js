export const CONFIG = Object.freeze({
  ...
  entityCrateCooldownsKey: "daily:entity_crate_cooldowns:v1",
  entityCrateCooldownLimit: 600,
  entityCrateInteractionDistance: 1,
  entityCrateScanRadiusChunks: 2,
  entityCrateMinSpawnDistance: 12,
  entityCrateSpawnsPerScan: 4,
  entityCrateMaxLoaded: 64,
  entityCrateSpawnScanTicks: 200,
