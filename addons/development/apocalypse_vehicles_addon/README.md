# Apocalypse Vehicles Addon (末日生存载具系统)

本 Addon 专为 **Minecraft Bedrock 末日枪械生存 / 搜打撤 / SAPI 经济服务器** 设计，深度兼容 `sapi_server_addon`、`survival_firearms_addon`、`test_guns_2d_addon` 等模组。
...
```bash
bash addons/development/apocalypse_vehicles_addon/build.sh
```
会自动生成：
- `Apocalypse_Vehicles_BP.mcpack`
- `Apocalypse_Vehicles_RP.mcpack`
- `Apocalypse_Vehicles_Addon.mcaddon`
