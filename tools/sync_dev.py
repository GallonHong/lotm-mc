...
links = [
    ...
    (development('apocalypse_vehicles_addon/apocalypse_vehicles_bp'), os.path.join(dev_bp_dir, 'apocalypse_vehicles_bp')),
    (development('apocalypse_vehicles_addon/apocalypse_vehicles_rp'), os.path.join(dev_rp_dir, 'apocalypse_vehicles_rp')),
