...
addon_dir = os.path.join(base_dir, 'apocalypse_vehicles_addon')
...
root_addon = os.path.join(base_dir, 'Apocalypse_Vehicles_Addon.mcaddon')
...
shutil.copy2(addon, root_addon)
print(f"Built Apocalypse Vehicles Addon successfully: {root_addon}")
