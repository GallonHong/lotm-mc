export const CONFIG = Object.freeze({
  ...
  cityReadyKey: "apoc_extract:city_ready:v7",
  previousCityReadyKey: "apoc_extract:city_ready:v6",
  ...
  cityLayoutVersion: 10,
  cityLayoutSentinel: { x: 1, y: 62, z: 0 },
  cityLayoutSentinelBlock: "minecraft:gold_block",
  airDropY: 180,
