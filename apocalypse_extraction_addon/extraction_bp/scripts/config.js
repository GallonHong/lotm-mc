export const CONFIG = Object.freeze({
  ...
  cityLayoutVersion: 12,
  cityLayoutSentinel: { x: 1, y: 62, z: 0 },
  cityLayoutSentinelBlock: "minecraft:diamond_block",
  airDropY: 180,
  ...
  extractionPoints: [
    { id: "metro_north_west", name: "西北地铁口", x: -256, z: -304 },
    { id: "metro_north", name: "北部地铁口", x: 0, z: -304 },
    { id: "checkpoint_north_east", name: "东北检查站", x: 256, z: -304 },
    { id: "rail_west_north", name: "西北铁路", x: -304, z: -256 },
    { id: "rail_west", name: "西部铁路", x: -304, z: 0 },
    { id: "sewer_west_south", name: "西南下水道", x: -304, z: 256 },
    { id: "bridge_east_north", name: "东北断桥", x: 304, z: -256 },
    { id: "bridge_east", name: "东部断桥", x: 304, z: 0 },
    { id: "service_east_south", name: "东南维修通道", x: 304, z: 256 },
    { id: "factory_south_west", name: "废厂后门", x: -256, z: 304 },
    { id: "tunnel_south", name: "南部隧道", x: 0, z: 304 },
    { id: "hospital_south_east", name: "医院停机坪", x: 256, z: 304 },
    { id: "garage_inner_nw", name: "西北地下车库", x: -128, z: -128 },
    { id: "mall_inner_n", name: "北部商场后门", x: 0, z: -128 },
    { id: "subway_inner_ne", name: "东北维修地铁口", x: 128, z: -128 },
    { id: "factory_inner_w", name: "西部厂区通道", x: -128, z: 0 },
    { id: "office_inner_e", name: "东部办公楼通道", x: 128, z: 0 },
    { id: "warehouse_inner_sw", name: "西南仓库后门", x: -128, z: 128 },
    { id: "hospital_inner_s", name: "南部急救通道", x: 0, z: 128 },
    { id: "station_inner_se", name: "东南车站出口", x: 128, z: 128 }
  ],
  mobPool: [
