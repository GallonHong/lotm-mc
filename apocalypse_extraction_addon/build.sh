...
cd "$ROOT"
rm -f Apocalypse_Extraction_City_BP.mcpack Apocalypse_Extraction_Dimension_Bootstrap_BP.mcpack Apocalypse_Extraction_City_RP.mcpack Apocalypse_Extraction_City_Addon.mcaddon Apocalypse_Extraction_City_Addon_v0.4.0.mcaddon
...
cp Apocalypse_Extraction_City_Addon.mcaddon Apocalypse_Extraction_City_Addon_v0.4.0.mcaddon
