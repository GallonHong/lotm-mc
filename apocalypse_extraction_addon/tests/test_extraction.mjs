...
assert.deepEqual(manifest.header.version, [0, 3, 0]);
assert.deepEqual(resourceManifest.header.version, [0, 3, 0]);
...
assert(manifest.dependencies.some(dep => dep.uuid === "714f16b3-b6ad-47f3-af06-dd93095da201" && dep.version.join(".") === "0.3.4"), "Apocalypse Mobs dependency missing");
assert(manifest.dependencies.some(dep => dep.uuid === "c6ef6f20-3d85-4d84-bf93-4b39e77e2760" && dep.version.join(".") === "0.6.1"), "Daily Events crate dependency missing");
...
console.log("Apocalypse Extraction City v0.3.0 validation passed.");
