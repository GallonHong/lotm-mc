...
assert.deepEqual(manifest.header.version, [0, 10, 5]);
assert.deepEqual(resourceManifest.header.version, [0, 10, 5]);
...
for (const marker of ["cityHalfSize: 384", "districtSpacing: 128", "districtCellSize: 16", "districtGridOrigin: -56", "city_ready:v8", "cityLayoutVersion: 12", 'cityLayoutSentinelBlock: "minecraft:diamond_block"', "activeStateKey", "lootNodesKey", "premiumCratePointsKey", "extractionOutpostVersionKey", "navigationChatIntervalTicks: 1200", "dusk_fog"]) assert(config.includes(marker), `missing dense-city config: ${marker}`);
...
console.log("Apocalypse Extraction City v0.10.5 validation passed.");
