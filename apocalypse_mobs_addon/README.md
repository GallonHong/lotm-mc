...
独立的 Minecraft Bedrock 主世界末日生存怪物与刷怪系统。v0.4.1 将六种 Ranzie 特殊感染者改为已验证的通用感染者骨架与原版僵尸动画，并补齐刷怪蛋纹理、实体名称和 Boss 名称，修复刷怪蛋及生成实体不可见、Boss 显示未知的问题。v0.4.0 新增喷吐者、尖啸者、冲锋者、猎手、重装暴君与召唤母体，以及分区域数值、技能、怪物池与护甲概率。
