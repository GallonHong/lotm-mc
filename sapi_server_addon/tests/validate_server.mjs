...
assert.equal(manifest.header.version.join("."), "2.9.1");
assert.equal(resourceManifest.header.version.join("."), "2.9.1");
...
console.log("SAPI Server v2.9.1 validation passed.");
