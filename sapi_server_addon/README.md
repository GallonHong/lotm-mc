...
独立的 Minecraft Bedrock 服务器基础系统，源码、测试、构建脚本和安装包全部位于本目录，不再与 LOTM Pathways 源码混放。v2.10.1 将保险箱右键、密码提交、存取、改密与回收统一限制在实体 2 格内；v2.10.0 在主菜单增加一级“社交”入口：好友与申请、在线玩家资料卡、私聊、好友领地观光、四人临时队伍和持久化公会。队伍由队长发起副本 Ready，公会创建费默认 15,000 金币、上限 30 人；公会基地只是传送点，不会自动创建领地。
