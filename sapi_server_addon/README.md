...
独立的 Minecraft Bedrock 服务器基础系统，源码、测试、构建脚本和安装包全部位于本目录，不再与 LOTM Pathways 源码混放。v2.6.0 在管理员控制台增加自然灾害管理，可以配置自动事件、作用维度、安全区与地形保护、时间、难度、随机权重，并能手动触发或停止五种灾害。摸金都市、副本入口和自定义寄卖名称等既有功能保持不变。
