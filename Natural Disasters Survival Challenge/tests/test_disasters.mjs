...
assert(bpManifest.dependencies.some(dep => dep.module_name === "@minecraft/server" && dep.version === "2.8.0"));
...
console.log("Natural Disasters Server Events v2.0.0 validation passed.");
