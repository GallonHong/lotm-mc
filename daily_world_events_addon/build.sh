...
versioned_addon="$addon_dir/Survival_Daily_Events_Addon_v0.9.0.mcaddon"

rm -f "$bp_pack" "$rp_pack" "$addon" "$addon_dir/Survival_Daily_Events_Addon_v0.7.0.mcaddon" "$addon_dir/Survival_Daily_Events_Addon_v0.8.0.mcaddon" "$versioned_addon"
